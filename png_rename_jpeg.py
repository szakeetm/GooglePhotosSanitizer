...
def rename_png_to_jpeg(directory):
            ...
            if file.lower().endswith('.png'):
                ...
                try:
                    ...
                    if imghdr.what(file_path) == 'jpeg':
                        ...
                        new_json_path = replace_png_with_jpg(json_path)
                        # Rename the file
...
def replace_png_with_jpg(file_path):
    ...
    new_name = name.replace('PNG', 'jpg').replace('png', 'jpg')
    
    # Return a new Path object with the modified name
    return parent / new_name

# Usage
takeout_path = takeout_path = "/Volumes/Ady_2tb_red/takeout_extract5/Takeout/Google_Photos"
rename_png_to_jpeg(takeout_path)